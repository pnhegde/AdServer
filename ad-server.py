...
class MainHandler(tornado.web.RequestHandler):
    ...
    def conversion(self,info):
        try:
            ...
            if campaignId==57:
	      self.write("document.write(\"<img height='1' width='1' style='border-style:none;' alt='' src='http://www.googleadservices.com/pagead/conversion/952217567/?value=1.4&amp;label=qG8FCMnP2gQQ39-GxgM&amp;guid=ON&amp;script=0'/>\")")
